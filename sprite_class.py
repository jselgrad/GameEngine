...
from helperFunctions import gameprint
pygame.init()
...
class sprite_class:
    ...
    #     xpos - the X coordinate you wish to draw the sprite at
    #     ypos - the Y coordinate you wish to draw the sprite at
    #  Return: none
    #
    #  This function causes the sprite to draw itself to the screen
    #  This function will also perform any animation operations
    #===========================================================================
    def draw(self,screen,xpos,ypos):
        ...
        screen.blit(self.mod_image_list[self.frameNumber],(xpos,ypos))
        gameprint(screen, str(self.frameNumber), xpos, ypos, (255,255,255))
    ...
    def create_animation(self,name, start,end,delay=0):
        if (delay != 0):
            self.animations[name] = (start, end, delay)
        else:
            self.animations[name] = (start, end, self.delayTimer)
            
    def load_animation(self,name):
        self.set_animation_frame(self.animations[name][0])
        self.set_animation_range(self.animations[name][0], self.animations[name][1])
        self.set_animation_delay(self.animations[name][2])
